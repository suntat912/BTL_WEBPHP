<?php
session_start(); // Đảm bảo bắt đầu phiên trước khi sử dụng $_SESSION
include __DIR__ . '/../includes/db.php'; // Đường dẫn đến db.php
...
$stmt->execute();
$categories = $stmt->fetchAll(); // Đảm bảo lấy dữ liệu về danh mục
